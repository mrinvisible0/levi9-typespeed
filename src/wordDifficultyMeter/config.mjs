...
let SAME_FINGER_PENALTY = 10; // multiplier
let SAME_HAND_PENALTY   = 1; // multiplier
...
export {buildMapping, SAME_FINGER_PENALTY,
                       SAME_HAND_PENALTY,
                       COORDINATES,
                       DISTANCES,
                       EFFORTS,
